...
<template>
	<main
		class="flex min-h-screen flex-col items-center justify-center gap-4 bg-slate-950 px-4 py-12 text-slate-100"
	>
		<div
			class="w-full max-w-md rounded-xl border border-slate-700 bg-slate-900 px-6 py-8 text-center shadow-lg"
		>
			...
			<p
				v-else-if="isExchangingSession"
				class="mt-4 text-xs uppercase tracking-wide text-slate-500"
			>
