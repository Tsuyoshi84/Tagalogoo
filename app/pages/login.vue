  ...
  <main class="flex min-h-screen flex-col items-center justify-center gap-6 bg-slate-900 px-4 py-12 text-slate-100">
    <section class="flex max-w-md flex-col items-center gap-4 text-center">
      ...
      <p class="text-base text-slate-300">
        Use your Google account to access lessons, track progress, and sync learning data securely with Supabase Auth.
      </p>
    </section>
    ...
    <section class="flex w-full max-w-sm flex-col items-stretch gap-3">
      <button
        ...
        type="button"
        class="inline-flex items-center justify-center gap-3 rounded-lg bg-white px-4 py-3 font-medium text-slate-900 shadow transition hover:bg-slate-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white disabled:cursor-not-allowed disabled:opacity-60"
        :disabled="isPending"
      ...
      <button
        v-else
        type="button"
        class="inline-flex items-center justify-center gap-3 rounded-lg border border-slate-500 px-4 py-3 font-medium text-slate-100 transition hover:bg-slate-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
        @click="handleSignOut"
      >
